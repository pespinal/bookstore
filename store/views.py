...
def checkout_paypal(request, cart, orders):
    if request.user.is_authenticated():
        ...
        paypalrestsdk.configure({
            "mode": "sandbox",
            "client_id": "AYI2RrFnu0Tt-ChALzOt9NhT-eMUqu8fwFHOrZWbByyvlQSZpMfmnlLvMOmrAMPeMWz88e5HdaopkQ3D",
            "client_secret": "ELzCUmIjBm4yT4_IawprHrQvOjajpMFQMV17o87nx16drssOrn0Dxehk7q8w6qc_8XTX3-3NnhsDNTOe"
        })
